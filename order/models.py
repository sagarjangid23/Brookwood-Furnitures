...
class Order(models.Model):
    ...
    total = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Gross & Profit Order Total')
    ...
    #shippingColony = models.CharField(max_length=250, blank=True)
